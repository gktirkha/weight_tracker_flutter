...
@JsonKey(name: 'timestamp') String get timestamp;@JsonKey(name: 'weight') double? get weight;@JsonKey(name: 'notes') String? get notes;@JsonKey(name: 'bmi') double? get bmi;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is WeightEntry&&(identical(other.timestamp, timestamp) || other.timestamp == timestamp)&&(identical(other.weight, weight) || other.weight == weight)&&(identical(other.notes, notes) || other.notes == notes)&&(identical(other.bmi, bmi) || other.bmi == bmi));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,timestamp,weight,notes,bmi);

@override
String toString() {
  return 'WeightEntry(timestamp: $timestamp, weight: $weight, notes: $notes, bmi: $bmi)';
}
...
@useResult
$Res call({
@JsonKey(name: 'timestamp') String timestamp,@JsonKey(name: 'weight') double? weight,@JsonKey(name: 'notes') String? notes,@JsonKey(name: 'bmi') double? bmi
});
...
/// Create a copy of WeightEntry
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? timestamp = null,Object? weight = freezed,Object? notes = freezed,Object? bmi = freezed,}) {
  return _then(_self.copyWith(
...
class _WeightEntry implements WeightEntry {
   _WeightEntry({@JsonKey(name: 'timestamp') required this.timestamp, @JsonKey(name: 'weight') required this.weight, @JsonKey(name: 'notes') required this.notes, @JsonKey(name: 'bmi') required this.bmi});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _WeightEntry&&(identical(other.timestamp, timestamp) || other.timestamp == timestamp)&&(identical(other.weight, weight) || other.weight == weight)&&(identical(other.notes, notes) || other.notes == notes)&&(identical(other.bmi, bmi) || other.bmi == bmi));
}
...
/// Create a copy of WeightEntry
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? timestamp = null,Object? weight = freezed,Object? notes = freezed,Object? bmi = freezed,}) {
