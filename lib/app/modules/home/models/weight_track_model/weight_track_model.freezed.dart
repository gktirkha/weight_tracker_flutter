...
@JsonKey(name: 'timestamp') String get timestamp;@JsonKey(name: 'weight') double? get weight;@JsonKey(name: 'notes') String? get notes;@JsonKey(name: 'date') DateTime get date;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is WeightEntry&&(identical(other.timestamp, timestamp) || other.timestamp == timestamp)&&(identical(other.weight, weight) || other.weight == weight)&&(identical(other.notes, notes) || other.notes == notes)&&(identical(other.date, date) || other.date == date));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,timestamp,weight,notes,date);

@override
String toString() {
  return 'WeightEntry(timestamp: $timestamp, weight: $weight, notes: $notes, date: $date)';
}
...
@useResult
$Res call({
@JsonKey(name: 'timestamp') String timestamp,@JsonKey(name: 'weight') double? weight,@JsonKey(name: 'notes') String? notes,@JsonKey(name: 'date') DateTime date
});
...
/// Create a copy of WeightEntry
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? timestamp = null,Object? weight = freezed,Object? notes = freezed,Object? date = null,}) {
  return _then(_self.copyWith(
...
class _WeightEntry implements WeightEntry {
   _WeightEntry({@JsonKey(name: 'timestamp') required this.timestamp, @JsonKey(name: 'weight') required this.weight, @JsonKey(name: 'notes') required this.notes, @JsonKey(name: 'date') required this.date});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _WeightEntry&&(identical(other.timestamp, timestamp) || other.timestamp == timestamp)&&(identical(other.weight, weight) || other.weight == weight)&&(identical(other.notes, notes) || other.notes == notes)&&(identical(other.date, date) || other.date == date));
}
...
/// Create a copy of WeightEntry
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? timestamp = null,Object? weight = freezed,Object? notes = freezed,Object? date = null,}) {
